                        ...
                        <div class="bottom-article">
                            <ul class="meta-post">
                                ...
                                @if ($WebmasterSection->comments_status)
                                    <li><i class="fa fa-comments"></i><a href="#comments">{{ __('frontend.comments') }}
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="bottom-article newcomment">
                                            ...
                                            <div class="form-group">
                                                {!! Form::text('comment_name', @Auth::user()->name, [
                                            ...
                                            <div class="form-group">
                                                {!! Form::email('comment_email', @Auth::user()->email, [
