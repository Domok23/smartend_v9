            ...
            <div class="row">
                <div class="col-lg-{{ $bx1w }}">
                    <div class="widget contacts">
                        <h4 class="widgetheading"><i class="fa fa-phone-square"></i>&nbsp;
                            {{ __('frontend.contactDetails') }}</h4>
                    ...
                    @if (count($FooterMenuLinks) > 0)
                        <div class="col-lg-{{ $bx3w }}">
                            <div class="widget">
                                ...
                                $slug_var2 = 'seo_url_slug_' . env('DEFAULT_LANGUAGE');
                                ?>
                                <h4 class="widgetheading"><i class="fa fa-bookmark"></i>&nbsp;
                                    {{ __('frontend.quickLinks') }}</h4>
                                <ul class="link-list">
                                    @foreach ($FooterMenuLinks as $FooterMenuLink)
                                        ...
                                        @if ($FooterMenuLink->type == 3 || $FooterMenuLink->type == 2)
                                            ...
                                            <li>
                                                <a
                                                    href="{{ Helper::sectionURL($FooterMenuLink->cat_id) }}">{{ $link_title }}</a>
                                            </li>
                ...
                <div class="col-lg-6">
                    <ul class="social-network">
                        @if (Helper::GeneralSiteSettings('social_link1'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link1') }}" data-placement="top"
                                    title="Facebook" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link2'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link2') }}" data-placement="top"
                                    title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link4'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link4') }}" data-placement="top"
                                    title="linkedin" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link5'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link5') }}" data-placement="top"
                                    title="Youtube" target="_blank"><i class="fa fa-youtube-play"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link6'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link6') }}" data-placement="top"
                                    title="Instagram" target="_blank"><i class="fa fa-instagram"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link7'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link7') }}" data-placement="top"
                                    title="Pinterest" target="_blank"><i class="fa fa-pinterest"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link8'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link8') }}" data-placement="top"
                                    title="Tumblr" target="_blank"><i class="fa fa-tumblr"></i></a></li>
                        @endif
                        @if (Helper::GeneralSiteSettings('social_link9'))
                            <li><a href="{{ Helper::GeneralSiteSettings('social_link9') }}" data-placement="top"
                                    title="Snapchat" target="_blank"><i class="fa fa-snapchat"></i></a></li>
                        @endif
...
@if (Helper::GeneralSiteSettings('social_link10'))
    <a href="https://wa.me/{{ Helper::GeneralSiteSettings('social_link10') }}" class="whatsapp_float" target="_blank"
