        ...
        <div class="form-block">
            ...
            @if ($WebmasterSection->title_status)
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('title', '', ['placeholder' => '', 'class' => 'form-control', 'required' => '']) !!}
                    </div>
                </div>
            @endif
            ...
            @if ($WebmasterSection->longtext_status)
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::textarea('details', '', ['placeholder' => '', 'class' => 'form-control', 'rows' => '8']) !!}
                    </div>
                </div>
            @endif
                                ...
                                <div class="col-sm-10">
                                    <div>
                                        <div class='input-group dateTime'>
                                            {!! Form::text('customField_' . $customField->id, '', [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'id' => 'customField_' . $customField->id,
                                                $cf_required => '',
            ...
            <div class="form-group row" style="margin-bottom: 0;margin-top: 30px;">
                ...
                <div class="col-sm-10">
                    ...
                    <button type="submit" class="btn btn-lg submit-btn btn-theme"><i class="fa fa-send"></i>
                        {{ __('backend.submit') }}</button>
                </div>
            </div>
            {{ Form::close() }}
        </div>
