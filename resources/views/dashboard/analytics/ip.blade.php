                        ...
                        <div class="col-sm-3">
                            <div class="btn-group pull-right">
                                ...
                                <div class="input-group input-group-sm">
                                    {!! Form::text('ip', $ip_code, [
                                        'placeholder' => __('backend.ip') . '...',
                                        'class' => 'form-control',
                                        'id' => 'name',
                                        'required' => '',
                                    ]) !!}
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($AnalyticsVisitors as $AnalyticsVisitor)
                                            @if ($lmt == 0)
                                                ...
                                                <tr>
                                                    <td class="dker">
                                                        {{ __('backend.visitorsAnalyticsByOperatingSystem') }}
                                                        :
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="dker">
                                                        {{ __('backend.visitorsAnalyticsByScreenResolution') }}
                                                        :
                                                    </td>
                    ...
                    <table class="table table-striped  b-t">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-info"><a href="{{ $page->query }}"
