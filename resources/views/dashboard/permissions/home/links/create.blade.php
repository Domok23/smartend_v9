            ...
            <div class="modal-body p-lg p-b-0">
                <div class=" p-a">
                    ...
                    @foreach (Helper::languagesList() as $ActiveLanguage)
                        @if ($ActiveLanguage->box_status)
                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label">{!! __('backend.topicName') !!}
                                    {!! @Helper::languageName($ActiveLanguage) !!}
                                </label>
                                <div class="col-sm-9">
                                    {!! Form::text('btn_title_' . @$ActiveLanguage->code, '', [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'required' => '',
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('link', '', ['dir' => 'ltr', 'class' => 'form-control', 'required' => '']) !!}
                        </div>
                    </div>


                    <div class="form-group row">
                        <label for="target0" class="col-sm-3 form-control-label">{!! __('backend.linkTarget') !!}</label>
                        <div class="col-sm-9">
                            <div class="radio m-t-sm">
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('target', '0', true, ['id' => 'target0', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                                    {!! __('backend.linkTargetParent') !!}
                                </label>
                                &nbsp;
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('target', '1', false, ['id' => 'target1', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('btn_class', 'btn btn-lg primary', ['dir' => 'ltr', 'class' => 'form-control', 'required' => '']) !!}
                        </div>
                    </div>
                </div>
            </div>
