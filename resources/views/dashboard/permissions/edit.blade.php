                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('view_status', '1', $Permissions->view_status == 1 ? true : false, [
                                            'id' => 'view_status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                    ...
                                    <br>
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('view_status', '0', $Permissions->view_status == 0 ? true : false, [
                                            'id' => 'view_status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="ui-check">
                                                {!! Form::checkbox('inbox_status', '1', $Permissions->inbox_status == 1 ? true : false, [
                                                    'id' => 'inbox_status',
                                                ]) !!}
                                                <i class="dark-white"></i><label
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="ui-check">
                                                {!! Form::checkbox('calendar_status', '1', $Permissions->calendar_status == 1 ? true : false, [
                                                    'id' => 'calendar_status',
                                                ]) !!}
                                                <i class="dark-white"></i><label
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="ui-check">
                                                {!! Form::checkbox('banners_status', '1', $Permissions->banners_status == 1 ? true : false, [
                                                    'id' => 'banners_status',
                                                ]) !!}
                                                <i class="dark-white"></i><label
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="ui-check">
                                                {!! Form::checkbox('settings_status', '1', $Permissions->settings_status == 1 ? true : false, [
                                                    'id' => 'settings_status',
                                                ]) !!}
                                                <i class="dark-white"></i><label
                                    ...
                                    <div class="col-sm-4">
                                        <div class="checkbox">
                                            <label class="ui-check">
                                                {!! Form::checkbox('webmaster_status', '1', $Permissions->webmaster_status == 1 ? true : false, [
                                                    'id' => 'webmaster_status',
                                                ]) !!}
                                                <i class="dark-white"></i><label
                                            ...
                                            <div class="checkbox">
                                                <label class="ui-check">
                                                    {!! Form::checkbox(
                                                        'data_sections[]',
                                                        $WebSection->id,
                                                        in_array($WebSection->id, $data_sections_arr) ? true : false,
                                                        ['id' => 'data_sections' . $i],
                                                    ) !!}
                                                    <i class="dark-white"></i><label
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('active_status', '1', $Permissions->active_status == 1 ? true : false, [
                                            'id' => 'active_status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('active_status', '0', $Permissions->active_status == 0 ? true : false, [
                                            'id' => 'active_status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('add_status', '1', $Permissions->add_status == 1 ? true : false, [
                                            'id' => 'add_status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('add_status', '0', $Permissions->add_status == 0 ? true : false, [
                                            'id' => 'add_status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('edit_status', '1', $Permissions->edit_status == 1 ? true : false, [
                                            'id' => 'edit_status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('edit_status', '0', $Permissions->edit_status == 0 ? true : false, [
                                            'id' => 'edit_status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('delete_status', '1', $Permissions->delete_status == 1 ? true : false, [
                                            'id' => 'delete_status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                                        {!! Form::radio('delete_status', '0', $Permissions->delete_status == 0 ? true : false, [
                                            'id' => 'delete_status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '1', $Permissions->status == 1 ? true : false, [
                                            'id' => 'status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '0', $Permissions->status == 0 ? true : false, [
                                            'id' => 'status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#btn_update_form').submit(function(evt) {
                evt.preventDefault();
                $('#link_update_submit').html(
                    "<img src=\"{{ asset('assets/dashboard/images/loading.gif') }}\" style=\"height: 25px\"/> {!! __('backend.add') !!}"
                    );
                    ...
                    success: function(result) {
                        ...
                        if (result.stat == 'success') {
                            ...
                            $.each(result.error, function(key, value) {
                                $('#btn_edit_errors').find("ul").append('<li>' + value +
                                    '</li>');
                            });
                        }
                        $('#link_update_submit').html(
                ...
                var xhr = $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result.stat == 'success') {
                            ...
                            $.each(result.error, function(key, value) {
                                $('#btn_add_errors').find("ul").append('<li>' + value +
                                    '</li>');
                            });
                        }
        ...
        function list_btns() {
            $('#buttons_list').html(
                "<div class=\"text-center\"><img class=\"m-b-1\" src=\"{{ asset('assets/dashboard/images/loading.gif') }}\" style=\"height: 35px;\"/></div>"
                );
