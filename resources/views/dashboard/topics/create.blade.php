            ...
            <div class="box-body">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                    ...
                                    {!! Form::text('date', Helper::formatDate(date('Y-m-d')), [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'date',
                                        'required' => '',
                ...
                @else
                    {!! Form::hidden('date', date('Y-m-d'), ['placeholder' => '', 'class' => 'form-control', 'id' => 'date']) !!}
                @endif
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                    ...
                                    {!! Form::text('expire_date', '', ['placeholder' => '', 'class' => 'form-control', 'id' => 'expire_date']) !!}
                                    <span class="input-group-addon">
                                        <span class="fa fa-calendar"></span>
                                    </span>
                                </div>
                            ...
                            <select name="section_id[]" id="section_id" class="form-control select2-multiple" multiple
                                ...
                                @foreach ($fatherSections as $fatherSection)
                                    ...
                                    @foreach ($fatherSection->fatherSections as $subFatherSection)
                                        ...
                                        ?>
                                        <option value="{{ $subFatherSection->id }}">{!! $ftitle !!}
                                            {!! $t_arrow !!} {!! $title !!}</option>
                                    @endforeach
                                @endforeach
                            </select>
                        </div>
                                        ...
                                        @if (Helper::GeneralWebmasterSettings('text_editor') == 2)
                                            <div>
                                                {!! Form::textarea(
                                                    ...
                                                    '<div dir=' . @$ActiveLanguage->direction . '><br></div>',
                                                    ['placeholder' => '', 'class' => 'form-control ckeditor', 'dir' => @$ActiveLanguage->direction],
                                                ) !!}
                                            </div>
                                        @elseif (Helper::GeneralWebmasterSettings('text_editor') == 1)
                                            <div>
                                                {!! Form::textarea(
                                                    'details_' . @$ActiveLanguage->code,
                                                    '<div dir=' . @$ActiveLanguage->direction . '><br></div>',
                                                    ['placeholder' => '', 'class' => 'form-control tinymce', 'dir' => @$ActiveLanguage->direction],
                                                ) !!}
                                            </div>
                                        @else
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('video_type', '0', true, [
                                        'id' => 'video_type1',
                                        'class' => 'has-value',
                                        'onclick' =>
                                            'document.getElementById("youtube_link_div").style.display="none";document.getElementById("embed_link_div").style.display="none";document.getElementById("vimeo_link_div").style.display="none";document.getElementById("files_div").style.display="block";document.getElementById("youtube_link").value=""',
                                    ]) !!}
                                ...
                                &nbsp; &nbsp;
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('video_type', '1', false, [
                                        'id' => 'video_type2',
                                        'class' => 'has-value',
                                        'onclick' =>
                                            'document.getElementById("youtube_link_div").style.display="block";document.getElementById("embed_link_div").style.display="none";document.getElementById("vimeo_link_div").style.display="none";document.getElementById("files_div").style.display="none";document.getElementById("youtube_link").value=""',
                                    ]) !!}
                                    <i class="dark-white"></i>
                                ...
                                &nbsp; &nbsp;
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('video_type', '2', false, [
                                        'id' => 'video_type2',
                                        'class' => 'has-value',
                                        'onclick' =>
                                            'document.getElementById("vimeo_link_div").style.display="block";document.getElementById("embed_link_div").style.display="none";document.getElementById("youtube_link_div").style.display="none";document.getElementById("files_div").style.display="none";document.getElementById("vimeo_link").value=""',
                                    ]) !!}
                                    <i class="dark-white"></i>
                        ...
                        @if ($cf_land_active)
                            ...
                            @elseif($customField->type == 6)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="{{ 'customField_' . $customField->id }}"
                                            id="{{ 'customField_' . $customField->id }}" class="form-control c-select"
                                            {{ $cf_required }}>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                {!! Form::text(
                                                    ...
                                                    Helper::formatDate($customField->default_value) . ' ' . date('h:i A', strtotime($customField->default_value)),
                                                    [
                                                        'placeholder' => '',
                                                        'class' => 'form-control',
                                                        'id' => 'customField_' . $customField->id,
                ...
                @if ($WebmasterSection->type == 0)
                    <div class="form-group row">
                        <label for="link_status" class="col-sm-2 form-control-label">{!! __('backend.pageCustomForm') !!}</label>
                        <div class="col-sm-10">
                            <select name="page_form_id" class="form-control c-select">
                                ...
                                @foreach ($GeneralWebmasterSections->where('type', 6) as $FWebmasterSection)
                                    <option value="{{ $FWebmasterSection->id }}">{!! $FWebmasterSection->{'title_' . @$ActiveLanguage->code} !!}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
