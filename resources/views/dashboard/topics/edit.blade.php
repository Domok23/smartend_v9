                    ...
                    <li class="nav-item inline dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-scale pull-right">
                            ...
                            <a class="dropdown-item text-info"
                                href="{{ @$Topics->webmasterSection->type == 4 || @$Topics->webmasterSection->type == 6 ? route('topicView', ['webmasterId' => @$Topics->webmasterSection->id, 'id' => $Topics->id]) : Helper::topicURL($Topics->id) }}"
            ...
            <div class="tab-content clear b-t">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                            ...
                                            {!! Form::text('date', Helper::formatDate($Topics->date), [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'id' => 'date',
                                                'required' => '',
                        ...
                        @else
                            {!! Form::hidden('date', $Topics->date, ['placeholder' => '', 'class' => 'form-control', 'id' => 'date']) !!}
                        @endif
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                            ...
                                            {!! Form::text('expire_date', Helper::formatDate($Topics->expire_date), [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'id' => 'expire_date',
                                            ]) !!}
                            ...
                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                @if ($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('title_' . @$ActiveLanguage->code, $Topics->{'title_' . @$ActiveLanguage->code}, [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'required' => '',
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                @if (Helper::GeneralWebmasterSettings('text_editor') == 2)
                                                    <div>
                                                        {!! Form::textarea('details_' . @$ActiveLanguage->code, $Topics->{'details_' . @$ActiveLanguage->code}, [
                                                            'placeholder' => '',
                        ...
                        @if ($WebmasterSection->type == 2)
                                ...
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '0', $Topics->video_type == 0 ? true : false, [
                                                'id' => 'video_type1',
                                                'class' => 'has-value',
                                                'onclick' =>
                                                    'document.getElementById("embed_link_div").style.display="none";document.getElementById("youtube_link_div").style.display="none";document.getElementById("vimeo_link_div").style.display="none";document.getElementById("files_div").style.display="block";document.getElementById("youtube_link").value=""',
                                            ]) !!}
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '1', $Topics->video_type == 1 ? true : false, [
                                                'id' => 'video_type2',
                                                'class' => 'has-value',
                                                'onclick' =>
                                                    'document.getElementById("embed_link_div").style.display="none";document.getElementById("youtube_link_div").style.display="block";document.getElementById("vimeo_link_div").style.display="none";document.getElementById("files_div").style.display="none";document.getElementById("youtube_link").value=""',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '2', $Topics->video_type == 2 ? true : false, [
                                                'id' => 'video_type2',
                                                'class' => 'has-value',
                                                'onclick' =>
                                                    'document.getElementById("embed_link_div").style.display="none";document.getElementById("vimeo_link_div").style.display="block";document.getElementById("youtube_link_div").style.display="none";document.getElementById("files_div").style.display="none";document.getElementById("vimeo_link").value=""',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '3', $Topics->video_type == 3 ? true : false, [
                                                'id' => 'video_type3',
                                                'class' => 'has-value',
                                                'onclick' =>
                                                    'document.getElementById("embed_link_div").style.display="block";document.getElementById("vimeo_link_div").style.display="none";document.getElementById("youtube_link_div").style.display="none";document.getElementById("files_div").style.display="none";document.getElementById("embed_link").value=""',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            Embed
                                        </label>
                            ...
                            <div id="files_div" style="display: {{ $Topics->video_type == 0 ? 'block' : 'none' }}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @endif
                                        {!! Form::file('video_file', ['class' => 'form-control', 'id' => 'video_file', 'accept' => '*']) !!}
                                    </div>
                                </div>
                            ...
                            <div class="form-group row" id="youtube_link_div"
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('youtube_link', $Topics->video_file, [
                                        'placeholder' => 'https://www.youtube.com/watch?v=JQs4QyKnYMQ',
                                        'class' => 'form-control',
                                        'id' => 'youtube_link',
                                        'dir' => 'ltr',
                                    ]) !!}
                            ...
                            <div class="form-group row" id="vimeo_link_div"
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('vimeo_link', $Topics->video_file, [
                                        'placeholder' => 'https://vimeo.com/131766159',
                                        'class' => 'form-control',
                                        'id' => 'vimeo_link',
                                        'dir' => 'ltr',
                                    ]) !!}
                            ...
                            <div class="form-group row" id="embed_link_div"
                                ...
                                <label for="embed_link"
                                    class="col-sm-2 form-control-label">{!! __('backend.bannerVideoUrl2') !!}</label>
                                <div class="col-sm-10">
                                    {!! Form::textarea('embed_link', $Topics->video_file, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'embed_link',
                                        'dir' => 'ltr',
                                ...
                                <div class="col-sm-10">
                                    @if ($Topics->audio_file != '')
                                        <div class="box p-a-xs">
                                            ...
                                            <br>
                                            <a target="_blank" href="{{ asset('uploads/topics/' . $Topics->audio_file) }}">
                                                {{ $Topics->audio_file }} </a>
                                        </div>
                                    @endif
                                    {!! Form::file('audio_file', ['class' => 'form-control', 'id' => 'audio_file', 'accept' => 'audio/*']) !!}
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    @if ($Topics->attach_file != '')
                                        <div id="topic_attach" class="col-sm-4 box p-a-xs">
                                            <a target="_blank"
                                                href="{{ asset('uploads/topics/' . $Topics->attach_file) }}">
                                                {{ $Topics->attach_file }} </a>
                                            <br>
                                        ...
                                        {!! Form::hidden('attach_delete', '0', ['id' => 'attach_delete']) !!}
                                    @endif
                                    {!! Form::file('attach_file', ['class' => 'form-control', 'id' => 'attach_file']) !!}
                                </div>
                            </div>
                            <div class="form-group row m-t-md" style="margin-top: 0 !important;">
                                <div class="offset-sm-2 col-sm-10">
                                ...
                                @if ($cf_land_active)
                                    @if ($customField->type == 12)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('customField_' . $customField->id, $cf_saved_val, [
                                                    'placeholder' => '',
                                                    'class' => 'form-control',
                                            ...
                                            <div class="col-sm-10">
                                                @if ($cf_saved_val != '')
                                                    ...
                                                    <div id="{{ $file_undo_id }}" class="col-sm-4 p-a-xs"
                                                        style="display: none">
                                                        <a
                                                            onclick="document.getElementById('{{ $file_name_id }}').style.display='block';document.getElementById('{{ $file_del_id }}').value='0';document.getElementById('{{ $file_undo_id }}').style.display='none';">
                                                            <i class="material-icons">
                                                                &#xe166;</i> {!! __('backend.undoDelete') !!}</a>
                                                    </div>

                                                    {!! Form::hidden($file_del_id, '0', ['id' => $file_del_id]) !!}
                                                    {!! Form::hidden($file_old_id, $cf_saved_val, ['id' => $file_old_id]) !!}
                                                @endif
                                                {!! Form::file('customField_' . $customField->id, [
                                                    'class' => 'form-control',
                                                    'id' => 'customField_' . $customField->id,
                                                    $cf_required => '',
                                                    'accept' => '*',
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="{{ 'customField_' . $customField->id }}[]"
                                                    id="{{ 'customField_' . $customField->id }}"
                                                    class="form-control select2-multiple" multiple ui-jp="select2"
                                                    ...
                                                    @foreach ($cf_details_lines as $cf_details_line)
                                                        <option value="{{ $line_num }}"
                                                            {{ in_array($line_num, $cf_saved_val_array) ? "selected='selected'" : '' }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="{{ 'customField_' . $customField->id }}"
                                                    ...
                                                    @foreach ($cf_details_lines as $cf_details_line)
                                                        <option value="{{ $line_num }}"
                                                            {{ $cf_saved_val == $line_num ? "selected='selected'" : '' }}>
                                                            {{ $cf_details_line }}</option>
                                                        <?php
                                                        $line_num++;
                                                        ?>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                        ...
                                                        {!! Form::text('customField_' . $customField->id, Helper::formatDate($cf_saved_val), [
                                                            'placeholder' => '',
                                                            'class' => 'form-control',
                                                            'id' => 'customField_' . $customField->id,
                                                            $cf_required => '',
                                    ...
                                    @elseif($customField->type == 3)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::email('customField_' . $customField->id, $cf_saved_val, [
                                                    'placeholder' => '',
                                                    'class' => 'form-control',
                                                    'id' => 'customField_' . $customField->id,
                                                    $cf_required => '',
                                    ...
                                    @elseif($customField->type == 2)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::number('customField_' . $customField->id, $cf_saved_val, [
                                                    'placeholder' => '',
                                                    'class' => 'form-control',
                                                    'id' => 'customField_' . $customField->id,
                                                    $cf_required => '',
                                    ...
                                    @elseif($customField->type == 1)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::textarea('customField_' . $customField->id, $cf_saved_val, [
                                                    'placeholder' => '',
                                                    'class' => 'form-control',
                                                    $cf_required => '',
                                                    'dir' => $cf_land_dir,
                                    ...
                                    <select name="page_form_id" class="form-control c-select">
                                        ...
                                        @foreach ($GeneralWebmasterSections->where('type', 6) as $FWebmasterSection)
                                            <option value="{{ $FWebmasterSection->id }}"
                                                {{ $FWebmasterSection->id == $Topics->form_id ? "selected='selected'" : '' }}>
                                                {!! $FWebmasterSection->{'title_' . @$ActiveLanguage->code} !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            @if ($WebmasterSection->case_status)
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="ui-check ui-check-md">
                                                {!! Form::radio('status', '1', $Topics->status == 1 ? true : false, ['id' => 'status1', 'class' => 'has-value']) !!}
                                                <i class="dark-white"></i>
                                                {{ __('backend.active') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="ui-check ui-check-md">
                                                {!! Form::radio('status', '0', $Topics->status == 0 ? true : false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                <i class="dark-white"></i>
