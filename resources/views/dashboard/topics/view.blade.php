                ...
                <ul class="nav">
                    @if (@Auth::user()->permissionsGroup->edit_status)
                        <li class="nav-item inline">
                            <a href="{!! route('topicsEdit', ['webmasterId' => @$Topic->webmasterSection->id, 'id' => $Topic->id]) !!}" data-toggle="tooltip"
                                data-original-title="{{ __('backend.edit') }}" class="btn btn-sm white"><i
                                    class="material-icons">&#xe3c9;</i></a>
                        </li>
                    @endif
                    <li class="nav-item inline">
                        <a class="btn btn-sm white" href="{{ route('topics', $WebmasterSection->id) }}" data-toggle="tooltip"
                            data-original-title="{{ __('backend.close') }}">
                            ...
                            <div class="col-sm-12">
                                ...
                                @foreach ($Topic->webmasterSection->customFields as $customField)
                                    ...
                                    @if ($customField->in_page)
                                        ...
                                        @if (($cf_saved_val != '' || count($cf_saved_val_array) > 0) &&
                                ...
                                <div class="bottom-article newcomment">
                                    <div id="sendmessage"><i class="fa fa-check-circle"></i>
                                        &nbsp;{{ __('frontend.youCommentSent') }} &nbsp; <a
                                            href="{{ url()->current() }}"><i class="fa fa-refresh"></i>
                                            {{ __('frontend.refresh') }}
                                        </a>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        {!! Form::hidden('comment_name', @Auth::user()->name, [
                                            'placeholder' => __('frontend.yourName'),
                                            'class' => 'form-control',
                                            'id' => 'comment_name',
                                            'data-msg' => __('frontend.enterYourName'),
                                            'data-rule' => 'minlen:4',
                                        ]) !!}
                                        <div class="alert alert-warning validation"></div>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::hidden('comment_email', @Auth::user()->email, [
                                            'placeholder' => __('frontend.yourEmail'),
                                            'class' => 'form-control',
                                            'id' => 'comment_email',
                                            'data-msg' => __('frontend.enterYourEmail'),
                                            'data-rule' => 'email',
                                        ]) !!}
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::textarea('comment_message', '', [
                                            'placeholder' => __('frontend.comment'),
                                            'class' => 'form-control',
                                            'id' => 'comment_message',
                                            'rows' => '5',
                                            'data-msg' => __('frontend.enterYourComment'),
                                            'data-rule' => 'required',
                                        ]) !!}
                                        <div class="validation"></div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="bottom-article newcomment">
                                    ...
                                    <div class="form-group">
                                        {!! Form::text('order_name', @Auth::user()->name, [
                                            'placeholder' => __('frontend.yourName'),
                                            'class' => 'form-control',
                                            'id' => 'order_name',
                                            'data-msg' => __('frontend.enterYourName'),
                                    ...
                                    <div class="form-group">
                                        {!! Form::text('order_phone', '', [
                                            'placeholder' => __('frontend.phone'),
                                            'class' => 'form-control',
                                            'id' => 'order_phone',
                                            'data-msg' => __('frontend.enterYourPhone'),
                                            'data-rule' => 'minlen:4',
                                        ]) !!}
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::email('order_email', @Auth::user()->email, [
                                            'placeholder' => __('frontend.yourEmail'),
                                            'class' => 'form-control',
                                            'id' => 'order_email',
                                            'data-msg' => __('frontend.enterYourEmail'),
                                    ...
                                    <div class="form-group">
                                        {!! Form::number('order_qty', '', [
                                            'placeholder' => __('frontend.quantity'),
                                            'class' => 'form-control',
                                            'id' => 'order_qty',
                                            'data-msg' => __('frontend.yourQuantity'),
                                            'data-rule' => 'minlen:1',
                                            'min' => '1',
                                        ]) !!}
                                        <div class="validation"></div>
                                    ...
                                    <div class="form-group">
                                        {!! Form::textarea('order_message', '', [
                                            'placeholder' => __('frontend.notes'),
                                            'class' => 'form-control',
                                            'id' => 'order_message',
                                            'rows' => '5',
                                        ]) !!}
