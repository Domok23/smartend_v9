@if ($WebmasterSection->maps_status)
    <div class="tab-pane  {{ $tab_5 }}" id="tab_maps">
        ...
        <div class="box-body">
            ...
            <div class="row">
                    ...
                    @if (Session::get('mapST') == 'edit')
                        <div class="offset-sm-2 col-sm-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    {!! Form::text('longitude', Session::get('Map')->longitude, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'longitude',
                                        'required' => '',
                                ...
                                <div class="col-sm-4">
                                    {!! Form::text('latitude', Session::get('Map')->latitude, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'latitude',
                                        'required' => '',
                            ...
                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                @if ($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">{!! __('backend.topicMapTitle') !!}
                                            {!! @Helper::languageName($ActiveLanguage) !!}
                                        </label>
                                        <div class="col-sm-9">
                                            {!! Form::text('title_' . @$ActiveLanguage->code, Session::get('Map')->{'title_' . @$ActiveLanguage->code}, [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'required' => '',
                            ...
                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                @if ($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        <label class="col-sm-3 form-control-label">{!! __('backend.topicMapDetails') !!}
                                            {!! @Helper::languageName($ActiveLanguage) !!}
                                        </label>
                                        <div class="col-sm-9">
                                            {!! Form::textarea(
                                                'details_' . @$ActiveLanguage->code,
                                                Session::get('Map')->{'details_' . @$ActiveLanguage->code},
                                                [
                                                    'placeholder' => '',
                                                    'class' => 'form-control',
                                                    'id' => 'details_' . @$ActiveLanguage->code,
                                                    'rows' => '3',
                                                    'dir' => @$ActiveLanguage->direction,
                                                ],
                                            ) !!}
                                ...
                                <div class="col-sm-9">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '0', true, ['id' => 'status1', 'class' => 'has-value']) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_0.png') }}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '1', Session::get('Map')->icon == 1 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_1.png') }}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '2', Session::get('Map')->icon == 2 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_2.png') }}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '3', Session::get('Map')->icon == 3 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_3.png') }}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '4', Session::get('Map')->icon == 4 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_4.png') }}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '5', Session::get('Map')->icon == 5 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_5.png') }}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('icon', '6', Session::get('Map')->icon == 6 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                            <img src="{{ asset('assets/dashboard/images/marker_6.png') }}"
                                                style="width: 25px;">
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('status', '1', Session::get('Map')->status == 1 ? true : false, [
                                                'id' => 'status1',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('status', '0', Session::get('Map')->status == 0 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                ...
                @else
                    <div>
                        <div id="mmn-{{ $Topics->id }}" class="modal fade" data-backdrop="true">
                                        ...
                                        <div>
                                            ...
                                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                                @if ($ActiveLanguage->box_status)
                                                    <div class="form-group row">
                                                        <label
                                                            class="col-sm-3 form-control-label">{!! __('backend.topicMapTitle') !!}
                                                            {!! @Helper::languageName($ActiveLanguage) !!}
                                                        </label>
                                                        <div class="col-sm-9">
                                            ...
                                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                                @if ($ActiveLanguage->box_status)
                                                    <div class="form-group row">
                                                        <label
                                                            class="col-sm-3 form-control-label">{!! __('backend.topicMapDetails') !!}
                                                            {!! @Helper::languageName($ActiveLanguage) !!}
                                                        </label>
                                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="radio">
                                                        ...
                                                        <label class="ui-check ui-check-md">
                                                            {!! Form::radio('icon', '1', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                            <i class="dark-white"></i>
                                                            <img src="{{ asset('assets/dashboard/images/marker_1.png') }}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            {!! Form::radio('icon', '2', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                            <i class="dark-white"></i>
                                                            <img src="{{ asset('assets/dashboard/images/marker_2.png') }}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            {!! Form::radio('icon', '3', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                            <i class="dark-white"></i>
                                                            <img src="{{ asset('assets/dashboard/images/marker_3.png') }}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            {!! Form::radio('icon', '4', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                            <i class="dark-white"></i>
                                                            <img src="{{ asset('assets/dashboard/images/marker_4.png') }}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            {!! Form::radio('icon', '5', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                            <i class="dark-white"></i>
                                                            <img src="{{ asset('assets/dashboard/images/marker_5.png') }}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            {!! Form::radio('icon', '6', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                            <i class="dark-white"></i>
                                                            <img src="{{ asset('assets/dashboard/images/marker_6.png') }}"
                                                                style="width: 25px;">
                                                        </label>
                        ...
                        <div class="row p-a" style="display: none">
                            <div class="col-sm-12">
                                <button class="btn btn-fw primary" data-toggle="modal"
                                    data-target="#mmn-{{ $Topics->id }}" ui-toggle-class="bounce" id="mapNew"
                                    ui-target="#animate">
                            ...
                            @if (count($Topics->maps) > 0)
                                        ...
                                        <thead class="dker">
                                            <tr>
                                                ...
                                                <th class="text-center" style="width:30px;">
                                                    {{ __('backend.status') }}</th>
                                                <th class="text-center" style="width:110px;">
                                                    {{ __('backend.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    <td class="dker"><label class="ui-check m-a-0">
                                                            <input type="checkbox" name="ids[]"
                                                                value="{{ $map->id }}"><i
                                                                class="dark-white"></i>
                                                            {!! Form::hidden('row_ids[]', $map->id, ['class' => 'form-control row_no']) !!}
                                                        </label>
                                                    </td>
                                                    <td>
                                                        {!! Form::text('row_no_' . $map->id, $map->row_no, [
                                                            'class' => 'pull-left form-control row_no',
                                                            'id' => 'row_no3',
                                                        ]) !!}
                                                        <img src="{{ asset('assets/dashboard/images/marker_') . $map->icon . '.png' }}"
                                                            style="width: 20px;">
                                                        @if ($title != '')
                                                            <small>{!! $title !!}</small>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        <i
                                                            class="fa {{ $map->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                                    </td>
                                                    <td class="text-center">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 hidden-xs">
                                        ...
                                        <button id="submit_show_msg3" class="btn white" data-toggle="modal"
                                            style="display: none" data-target="#mm-all" ui-toggle-class="bounce"
                    ...
                    <div id="mapDiv" class="col-sm-{{ $map_wds }}" {!! $map_dsp !!}>
                        <div style="margin-bottom: 3px;">
                            <small>
                                ...
                                <a data-toggle="modal" data-target="#mmn-{{ $Topics->id }}"
                                    ui-toggle-class="bounce" ui-target="#animate">
                                    <u>
    ...
    @push('after-scripts')
        <script type="text/javascript"
            src="//maps.google.com/maps/api/js?key={{ env('GOOGLE_MAPS_KEY') }}&language={{ @Helper::currentLanguage()->code }}">
        </script>
        <script type="text/javascript">
                    ...
                    geocoder.geocode({
                        ...
                        if (status == google.maps.GeocoderStatus.OK) {
                            if (results[0]) {
                                @foreach (Helper::languagesList() as $ActiveLanguage)
                                    @if ($ActiveLanguage->box_status)
                                        $("#details_{{ @$ActiveLanguage->code }}").val(results[0]
                                            .formatted_address);
                                    @endif
                                @endforeach
