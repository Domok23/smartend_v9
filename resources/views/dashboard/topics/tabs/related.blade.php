                ...
                @if (Session::get('relatedST') == 'create')
                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            <label for="file_title_ar" class="col-sm-2 form-control-label">{!! __('backend.siteSectionsSettings') !!}
                            </label>
                            <div class="col-sm-10">
                                <select name="related_section_id" id="related_section_id" class="form-control c-select">
                                    ...
                                    @foreach ($GeneralWebmasterSections as $WebmasterSection)
                                        ...
                                        ?>
                                        <option value="{{ $WebmasterSection->id }}">{!! $WSectionTitle !!}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="file_title_ar" class="col-sm-2 form-control-label">{!! __('backend.relatedTopics') !!}
                            </label>
                            <div class="col-sm-10">
                                <div id="r_topics"
                            ...
                            @foreach ($Topics->relatedTopics as $relatedTopic)
                                ...
                                <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $relatedTopic->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]', $relatedTopic->id, ['class' => 'form-control row_no']) !!}
                                        </label>
                                    </td>
                                    <td> {!! Form::text('row_no_' . $relatedTopic->id, $relatedTopic->row_no, [
                                    ...
                                    <td class="text-center">
                                        @if (@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning" data-toggle="modal"
                                                data-target="#mf-{{ $relatedTopic->id }}" ui-toggle-class="bounce"
                                                ui-target="#animate">
                                ...
                                <!-- .modal -->
                                <div id="mf-{{ $relatedTopic->id }}" class="modal fade" data-backdrop="true">
