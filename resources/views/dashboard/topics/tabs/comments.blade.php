                ...
                @if (Session::get('commentST') == 'edit')
                    <div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('name', Session::get('Comment')->name, [
                                    'placeholder' => '',
                                    'class' => 'form-control',
                                    'id' => 'name',
                                    'required' => '',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::email('email', Session::get('Comment')->email, [
                                    'placeholder' => '',
                                    'class' => 'form-control',
                                    'id' => 'email',
                                    'required' => '',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('comment', Session::get('Comment')->comment, [
                                    'placeholder' => '',
                                    'class' => 'form-control',
                                    'id' => 'comment',
                                    'required' => '',
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '1', Session::get('Comment')->status == 1 ? true : false, [
                                            'id' => 'status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '0', Session::get('Comment')->status == 0 ? true : false, [
                                            'id' => 'status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                ...
                @if (count($Topics->comments) > 0)
                            ...
                            @foreach ($Topics->comments as $comment)
                                <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $comment->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]', $comment->id, ['class' => 'form-control row_no']) !!}
                                        </label>
                                    </td>
                                    <td>
                                        {!! Form::text('row_no_' . $comment->id, $comment->row_no, [
                                    ...
                                    <td class="text-center">
                                        <i
                                            class="fa {{ $comment->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        @if (@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning" data-toggle="modal"
                                                data-target="#mc-{{ $comment->id }}" ui-toggle-class="bounce"
                                                ui-target="#animate">
                                                <small><i class="material-icons">
                                                        &#xe872;</i> {{ __('backend.delete') }}
                                                </small>
                    ...
                    <div class="row">
                        <div class="col-sm-3 hidden-xs">
                            ...
                            <select name="action" id="action2" class="form-control c-select w-sm inline v-middle"
                                required>
                            ...
                            <button id="submit_show_msg2" class="btn white" data-toggle="modal"
                                style="display: none" data-target="#mc-all" ui-toggle-class="bounce"
