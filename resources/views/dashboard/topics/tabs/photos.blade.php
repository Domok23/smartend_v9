                ...
                <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3">
                            <div class="box p-a-xs">
                                <div class="pull-right">
                                    {!! Form::text('row_no_' . $photo->id, $photo->row_no, [
                                ...
                                <label class="ui-check m-a-0 p-a-0">
                                    <input type="checkbox" name="ids[]" value="{{ $photo->id }}"><i
                                        class="dark-white"></i>
                                    {!! Form::hidden('row_ids[]', $photo->id, ['class' => 'form-control row_no']) !!}
                                </label>
                                <img src="{{ asset('uploads/topics/' . $photo->file) }}" alt="{{ $photo->title }}"
                                    title="{{ $photo->title }}" style="height: 150px" class="img-responsive">
                                <div class="p-a-sm">
                                    <div class="text-ellipsis">
                                        @if (@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning pull-right" data-toggle="modal"
                                                data-target="#mx-{{ $photo->id }}" ui-toggle-class="bounce"
                                                ui-target="#animate" title="{{ __('backend.delete') }}"
                                                style="padding: 0 5px 2px;">
                                                <small><i class="material-icons">&#xe872;</i></small>
                                            </button>
                                        @endif
                                        <a style="display: block;overflow: hidden;"
                                            href="{{ asset('uploads/topics/' . $photo->file) }}" target="_blank">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <label class="ui-check m-a-0">
                            <input id="checkAll" type="checkbox"><i></i> {{ __('backend.checkAll') }}
                        </label>
                        <div class="pull-right">
