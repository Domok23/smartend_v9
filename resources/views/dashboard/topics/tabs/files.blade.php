            ...
            @if (Session::has('fileST'))
                @if (Session::get('fileST') == 'create')
                    <div>
                        ...
                        <div class="form-group row">
                            <label for="files_file" class="col-sm-2 form-control-label">{!! __('backend.topicAttach') !!}</label>
                            <div class="col-sm-10">
                                {!! Form::file('file', ['class' => 'form-control', 'id' => 'attach_file', 'required' => '']) !!}
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::text(
                                            ...
                                            Session::get('AttachFile')->{'title_' . @$ActiveLanguage->code},
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-4 box p-a-xs">
                                    <a target="_blank"
                                        href="{{ asset('uploads/topics/' . Session::get('AttachFile')->file) }}">
                                        {!! Helper::GetIcon(asset('uploads/topics/'), Session::get('AttachFile')->file) !!} {{ Session::get('AttachFile')->file }} </a>
                                </div>
                                {!! Form::file('file', ['class' => 'form-control', 'id' => 'files_file']) !!}
                            </div>
                        </div>
                        <div class="form-group row m-t-md" style="margin-top: 0 !important;">
                            <div class="offset-sm-2 col-sm-10">
                ...
                @if (count($Topics->attachFiles) > 0)
                            ...
                            @foreach ($Topics->attachFiles as $file)
                                ...
                                <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $file->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]', $file->id, ['class' => 'form-control row_no']) !!}
                                        </label>
                                    </td>
                                    <td>
                                        {!! Form::text('row_no_' . $file->id, $file->row_no, ['class' => 'pull-left form-control row_no']) !!}
                                        <a href="{{ asset('uploads/topics/' . $file->file) }}" target="_blank">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if (@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning" data-toggle="modal"
                                                data-target="#mf-{{ $file->id }}" ui-toggle-class="bounce"
                                                ui-target="#animate">
                                                <small><i class="material-icons">
                                                        &#xe872;</i> {{ __('backend.delete') }}
                                                </small>
                    ...
                    <div class="row">
                        <div class="col-sm-3 hidden-xs">
                            ...
                            <select name="action" id="action4" class="form-control c-select w-sm inline v-middle"
                                required>
                            ...
                            <button id="submit_show_msg4" class="btn white" data-toggle="modal"
                                style="display: none" data-target="#mf-all" ui-toggle-class="bounce"
