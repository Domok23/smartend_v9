            ...
            <table class="responsive-table center-table" style="width: 100%">
                <thead class="dker">
                    @if ($WebmasterSection->title_status)
                        <th style="text-align: {{ @Helper::currentLanguage()->left }} !important;">
                            {{ __('backend.topicName') }}</th>
                    @endif
                ...
                <tbody>
                    @foreach ($Topics as $Topic)
                        <tr>
                            ...
                            ?>
                            @if ($WebmasterSection->title_status)
                                <td style="text-align: {{ @Helper::currentLanguage()->left }} !important;">
                                    {!! $photo . "<div class='h6'>" . $icon . $title . '</div>' . $section . $comments !!}</td>
                            @endif
                            <?php
