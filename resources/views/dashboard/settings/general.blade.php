<div class="tab-pane {{ Session::get('active_tab') == 'infoTab' || Session::get('active_tab') == '' ? 'active' : '' }}"
    ...
    <div class="p-a-md">
        <h5><i class="material-icons">&#xe30c;</i>
            &nbsp; {!! __('backend.siteInfoSettings') !!}</h5>
    </div>
    <div class="p-a-md col-md-12">
        @foreach (Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
                ...
                {!! Form::text('site_title_' . @$ActiveLanguage->code, $Setting->{'site_title_' . @$ActiveLanguage->code}, [
                    'placeholder' => '',
                    'class' => 'form-control',
        ...
        @foreach (Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
                ...
                {!! Form::textarea('site_desc_' . @$ActiveLanguage->code, $Setting->{'site_desc_' . @$ActiveLanguage->code}, [
                    'placeholder' => '',
                    'class' => 'form-control',
                    'dir' => @$ActiveLanguage->direction,
                    'rows' => '2',
        ...
        @foreach (Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
                ...
                {!! Form::textarea(
                    'site_keywords_' . @$ActiveLanguage->code,
                    $Setting->{'site_keywords_' . @$ActiveLanguage->code},
                    ['placeholder' => '', 'class' => 'form-control', 'dir' => @$ActiveLanguage->direction, 'rows' => '2'],
                ) !!}
            </div>
        @endforeach
        <div class="form-group">
