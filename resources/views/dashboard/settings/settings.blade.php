...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('assets/dashboard/js/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}"
        type="text/css" />
@endpush
@section('content')
    <div class="padding">
        <div class="row-col">
            ...
            <div class="col-sm-7 col-lg-10 light lt">
                ...
                <div class="tab-content pos-rlt">
                    <button type="submit" class="btn primary m-a pull-right"><i class="material-icons">&#xe31b;</i>
