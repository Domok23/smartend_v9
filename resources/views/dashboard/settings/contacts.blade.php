<div class="tab-pane {{ Session::get('active_tab') == 'contactsTab' ? 'active' : '' }}" id="tab-2">
    <div class="p-a-md">
        <h5><i class="material-icons">&#xe0ba;</i>
            &nbsp; {!! __('backend.siteContactsSettings') !!}</h5>
    </div>
    <div class="p-a-md col-md-12">
        @foreach (Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
                ...
                {!! Form::text('contact_t1_' . @$ActiveLanguage->code, $Setting->{'contact_t1_' . @$ActiveLanguage->code}, [
                    'placeholder' => '',
                    'class' => 'form-control',
        ...
        <div class="form-group">
            ...
            {!! Form::text('contact_t4', $Setting->contact_t4, [
        ...
        <div class="form-group">
            ...
            {!! Form::text('contact_t5', $Setting->contact_t5, [
        ...
        @foreach (Helper::languagesList() as $ActiveLanguage)
            <div class="form-group">
                ...
                {!! Form::text('contact_t7_' . @$ActiveLanguage->code, $Setting->{'contact_t7_' . @$ActiveLanguage->code}, [
                    'placeholder' => '',
                    'class' => 'form-control',
                    'dir' => @$ActiveLanguage->direction,
                ]) !!}
