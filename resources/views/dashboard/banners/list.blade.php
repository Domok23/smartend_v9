                                ...
                                <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $Banner->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]', $Banner->id, ['class' => 'form-control row_no']) !!}
                                        </label>
                                    </td>
                                    <td class="h6">
                                        {!! Form::text('row_no_' . $Banner->id, $Banner->row_no, ['class' => 'form-control row_no', 'id' => 'row_no']) !!}
                                        @if ($Banner->icon != '')
                                    ...
                                    <td class="text-center">
                                        <i
                                            class="fa {{ $Banner->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                    </td>
                                    <td class="text-center">
