        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="title_en" class="col-sm-2 form-control-label">{!! __('backend.sendTo') !!}
                    </label>
                    <div class="col-sm-9">
                        {!! Form::email('to_email', $from_email, [
                            'placeholder' => '',
                            'class' => 'form-control',
                            'id' => 'to_email',
                            'required' => '',
                    ...
                    <div class="col-sm-1">
                        <small>
                            <a
                                onclick="document.getElementById('cc').style.display='block'">{!! __('backend.sendCc') !!}</a><br>
                            <a
                                onclick="document.getElementById('bcc').style.display='block'">{!! __('backend.sendBcc') !!}</a>
                        </small>
                    </div>
                </div>
                ...
                <div id="cc" style="<?php echo $cc; ?>" class="form-group row">
                    <label for="title_en" class="col-sm-2 form-control-label">{!! __('backend.sendCc') !!}
                    </label>
                    <div class="col-sm-9">
                        {!! Form::email('to_cc', $to_cc, ['placeholder' => '', 'class' => 'form-control', 'id' => 'to_cc']) !!}
                    </div>
                    <div class="col-sm-1">
                        <a
                            onclick="document.getElementById('to_cc').value='';document.getElementById('cc').style.display='none'"><i
                                class="material-icons md-18">×</i></a>
                    </div>
                </div>
                <div id="bcc" style="<?php echo $bcc; ?>" class="form-group row">
                    <label for="title_en" class="col-sm-2 form-control-label">{!! __('backend.sendBcc') !!}
                    </label>
                    <div class="col-sm-9">
                        {!! Form::email('to_bcc', $to_bcc, ['placeholder' => '', 'class' => 'form-control', 'id' => 'to_bcc']) !!}
                    </div>
                    <div class="col-sm-1">
                        <a
                            onclick="document.getElementById('to_bcc').value='';document.getElementById('bcc').style.display='none'"><i
                                class="material-icons md-18">×</i></a>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="title_en" class="col-sm-2 form-control-label">{!! __('backend.sendTitle') !!}
                    </label>
                    <div class="col-sm-10">
                        {!! Form::text('title', $msg_title, [
                            'placeholder' => '',
                            'class' => 'form-control',
                            'id' => 'title',
                            'required' => '',
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <div class="box p-a-xs">
                            {!! Form::textarea('details', $msg_details, [
                                'ui-jp' => 'summernote',
                                'placeholder' => '',
                                'class' => 'form-control',
                                'ui-options' => '{height: 250}',
                            ]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="attach_files" class="col-sm-2 form-control-label">{!! __('backend.AttachFiles') !!}</label>
                    <div class="col-sm-10">
                        {!! Form::file('attach_files[]', ['class' => 'form-control', 'id' => 'attach_files', 'multiple' => '']) !!}
                    </div>
                </div>
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        {!! Form::hidden('btn_clicked', '', ['id' => 'btn_clicked']) !!}
                        <button type="submit" name="btn_send" onclick="document.getElementById('btn_clicked').value=''"
                            class="btn btn-primary m-t"><i class="material-icons">
                                &#xe31b;</i> {!! __('backend.send') !!}</button>
                        <button type="submit" name="btn_draft"
                            onclick="document.getElementById('btn_clicked').value='draft'"
                            class="btn btn-default m-t"><i class="material-icons">
                                &#xe161;</i> {!! __('backend.SaveToDraft') !!}</button>
                        <a href="{{ route('webmails') }}" class="btn btn-default m-t"><i class="material-icons">
        ...
        <div class="col-sm-12">
            <div class="p-b-1 pull-right">
                <a href="{{ route('webmails', ['group_id' => 'create', 'stat' => 'replay', 'wid' => Session::get('WebmailToEdit')->id]) }}"
                    class="btn btn-sm success p-r-1"><i class="fa fa-mail-reply"></i> {!! __('backend.replay') !!}</a>

                <a href="{{ route('webmails', ['group_id' => 'create', 'stat' => 'forward', 'wid' => Session::get('WebmailToEdit')->id]) }}"
                    class="btn btn-sm btn-info p-r-1 "><i class="fa fa-mail-forward"></i> {!! __('backend.forward') !!}</a>

                <a class="btn btn-sm btn-default p-r-1" onClick="window.print();"><i class="fa fa-print"></i>
                    {!! __('backend.print') !!}
                </a>
            </div>
            <br>
                    ...
                    <div class="row">
                        ...
                        @foreach (Session::get('WebmailToEdit')->files as $file)
                            <div class="col-sm-3">
                                ...
                                ?>
                                <a href="{{ asset('uploads/inbox/' . $file->file) }}" target="_blank"><img
                                        src="{{ asset('uploads/inbox/' . $file->file) }}" style="max-width: 100%"
                                        alt=""></a>
                                <?php
                                }
                                ?>
