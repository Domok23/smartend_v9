                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::text('seo_title_' . @$ActiveLanguage->code, $Sections->{'seo_title_' . @$ActiveLanguage->code}, [
                                        'class' => 'form-control',
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::text('seo_url_slug_' . @$ActiveLanguage->code, $Sections->{'seo_url_slug_' . @$ActiveLanguage->code}, [
                                        'class' => 'form-control',
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::textarea(
                                        ...
                                        $Sections->{'seo_description_' . @$ActiveLanguage->code},
                                        [
                                            'class' => 'form-control',
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    {!! Form::textarea(
                                        ...
                                        $Sections->{'seo_keywords_' . @$ActiveLanguage->code},
                                        [
                                            'class' => 'form-control',
                                ...
                                <div class="search-example-div">
                                    ...
                                    <div class="search-example" dir="{{ @$ActiveLanguage->direction }}">
                                        <a id="title_in_engines_{{ @$ActiveLanguage->code }}"
                                            href="{{ $seo_example_url }}" target="_blank">{{ $seo_example_title }}</a>
                                        <span
