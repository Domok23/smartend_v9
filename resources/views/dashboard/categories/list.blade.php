                                ...
                                <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $Section->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]', $Section->id, ['class' => 'form-control row_no']) !!}
                                        </label>
                                    </td>
                                    <td class="h6">
                                        @if ($Section->photo != '')
                                        ...
                                        @endif
                                        {!! Form::text('row_no_' . $Section->id, $Section->row_no, ['class' => 'form-control row_no', 'id' => 'row_no']) !!}
                                        @if ($Section->icon != '')
                                    ...
                                    <td class="text-center">
                                        <i
                                            class="fa {{ $Section->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                    </td>
                                    <td class="text-center">
                                        <a class="btn btn-sm info" href="{{ Helper::categoryURL($Section->id) }}"
                                    ...
                                    <tr>
                                        <td class="dker"><label class="ui-check m-a-0">
                                                <input type="checkbox" name="ids[]" value="{{ $subSection->id }}"><i
                                                    class="dark-white"></i>
                                                {!! Form::hidden('row_ids[]', $subSection->id, ['class' => 'form-control row_no']) !!}
                                            </label>
                                        </td>
                                        <td class="h6">
                                            @if ($subSection->photo != '')
                                            ...
                                            <img src="{{ asset('assets/dashboard/images/treepart_' . @Helper::currentLanguage()->direction . '.png') }}"
                                                class="submenu_tree">
                                            {!! Form::text('row_no_' . $subSection->id, $subSection->row_no, [
                                        ...
                                        <td class="text-center">
                                            <i
                                                class="fa {{ $subSection->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                        </td>

                                        <td class="text-center">
                                            <a class="btn btn-sm info" href="{{ Helper::categoryURL($subSection->id) }}"
                                                data-toggle="tooltip" data-original-title="{{ __('backend.viewDetails') }}"
                                                target="_blank">
                                                <i class="material-icons">&#xe8f4;</i>
                                            </a>
...
@push('after-scripts')
    <script type="text/javascript">
        ...
        function DeleteCategory(id) {
            $("#category_delete_btn").attr("href",
                '{{ route('categoriesDestroy', ['webmasterId' => $WebmasterSection->id]) }}/' + id);
