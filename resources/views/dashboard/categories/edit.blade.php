                    ...
                    <div class="box-body">
                        ...
                        @if ($WebmasterSection->sections_status == 2)
                            <div class="form-group row">
                                <label for="father_id" class="col-sm-2 form-control-label">{!! __('backend.categoryFather') !!} </label>
                                <div class="col-sm-10">
                                    <select name="father_id" id="father_id" class="form-control c-select">
                                        ...
                                        @foreach ($fatherSections as $fatherSection)
                                            ...
                                            <option value="{{ $fatherSection->id }}"
                                                {{ $fatherSection->id == $Sections->father_id ? "selected='selected'" : '' }}>
                                                {{ $title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        @foreach (Helper::languagesList() as $ActiveLanguage)
                            @if ($ActiveLanguage->box_status)
                                <div class="form-group row">
                                    <label class="col-sm-2 form-control-label">{!! __('backend.categoryName') !!}
                                        {!! @Helper::languageName($ActiveLanguage) !!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('title_' . @$ActiveLanguage->code, $Sections->{'title_' . @$ActiveLanguage->code}, [
                                            'placeholder' => '',
                                            'class' => 'form-control',
                                            'required' => '',
                        ...
                        <div class="form-group row">
                            <label for="photo" class="col-sm-2 form-control-label">{!! __('backend.sectionIcon') !!}</label>
                            <div class="col-sm-10">
                                @if ($Sections->photo != '')
                                    <div class="row">
                                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '1', $Sections->status == 1 ? true : false, [
                                            'id' => 'status1',
                                            'class' => 'has-value',
                                        ]) !!}
                                    ...
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '0', $Sections->status == 0 ? true : false, [
                                            'id' => 'status2',
                                            'class' => 'has-value',
                                        ]) !!}
                                        <i class="dark-white"></i>
                        ...
                        <div class="form-group row m-t-md">
                            <div class="offset-sm-2 col-sm-10">
                                ...
                                <a href="{{ route('categories', $WebmasterSection->id) }}" class="btn btn-default m-t"><i
