        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-lg">
                <div class="form-group row">
                    <label for="name" class="col-sm-3 form-control-label">{{ __('backend.languageCode') }}</label>
                    <div class="col-sm-9">
                        {!! Form::text('code', '', [
                            'placeholder' => 'en',
                            'class' => 'form-control',
                ...
                <div class="form-group row">
                    <label for="name" class="col-sm-3 form-control-label">{{ __('backend.languageTitle') }}</label>
                    <div class="col-sm-9">
                        {!! Form::text('title', '', ['placeholder' => 'English', 'class' => 'form-control', 'required' => '']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <label for="name"
                ...
                <div class="form-group row">
                    <label for="name" class="col-sm-3 form-control-label">{{ __('backend.languageIcon') }}</label>
                    <div class="col-sm-9">
                        <select name="icon"
                            class="form-control select2 select2-hidden-accessible select2-allow-clear" ui-jp="select2"
                            ...
                            @foreach ($Countries as $country)
                                ...
                                <option value="{{ $country->code }}"
                                    data-data='{"image": "{{ asset('assets/dashboard/images/flags/' . mb_strtolower($country->code) . '.svg') }}","code":"+{{ $country->tel }}","search-text":"{{ $country->{'title_' . __('backend.boxCode')} }}  +{{ $country->tel }}"}'>
                                    {{ $title }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="modal-body p-lg">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control c-select" name="direction" required>
                                    <option value="ltr"
                                        {{ $Language->direction == 'ltr' ? "selected='selected'" : '' }}>
                                        Left To Right
                                    </option>
                                    <option value="rtl"
                                        {{ $Language->direction == 'rtl' ? "selected='selected'" : '' }}>
                                        Right To Left
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control c-select" name="fields" required>
                                    <option value="1" {{ $Language->box_status == '1' ? "selected='selected'" : '' }}>
                                        {{ __('backend.active') }}</option>
                                    <option value="0" {{ $Language->box_status == '0' ? "selected='selected'" : '' }}>
                                        {{ __('backend.notActive') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="icon"
                                    ...
                                    @foreach ($Countries as $country)
                                        ...
                                        ?>
                                        <option value="{{ $country->code }}"
                                            {{ $Language->icon == trim(strtolower($country->code)) ? "selected='selected'" : '' }}>
                                            {{ $title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control c-select" name="status" required>
                                    <option value="1" {{ $Language->status == '1' ? "selected='selected'" : '' }}>
                                        {{ __('backend.active') }}</option>
                                    <option value="0" {{ $Language->status == '0' ? "selected='selected'" : '' }}>
                                        {{ __('backend.notActive') }}</option>
                                </select>
                            </div>
                        </div>
