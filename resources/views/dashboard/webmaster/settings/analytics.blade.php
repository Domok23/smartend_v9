<div class="tab-pane {{ Session::get('active_tab') == 'analyticsTab' ? 'active' : '' }}" id="tab-11">
    <div class="p-a-md">
        <h5>{!! __('backend.analyticsSettings') !!}</h5>
    </div>
            ...
            <div class="radio">
                <div>
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('geoip_status', '0', env('GEOIP_STATUS') == 0, ['id' => 'sms_status2', 'class' => 'has-value']) !!}
                ...
                <div style="margin-top: 5px;">
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('geoip_status', '1', env('GEOIP_STATUS') == 1, ['id' => 'sms_status1', 'class' => 'has-value']) !!}
                        <i class="dark-white"></i>
                        {{ __('backend.active') }}
                    </label>
                </div>
        ...
        <div id="geoip_service_info" class="{{ env('GEOIP_STATUS') == 1 ? '' : 'displayNone' }}">
            <div class="form-group">
                ...
                <select name="geoip_service" class="form-control c-select">
                    ...
                    <option value="ipgeolocation"
                        {{ env('GEOIP_SERVICE') == 'ipgeolocation' ? "selected='selected'" : '' }}>
            ...
            <div class="form-group">
                ...
                {!! Form::text('geoip_service_key', env('GEOIP_SERVICE_KEY'), [
                    'placeholder' => '',
                    'class' => 'form-control',
                    'dir' => trans('backLang.ltr'),
                ]) !!}
            </div>
            <div class="form-group">
