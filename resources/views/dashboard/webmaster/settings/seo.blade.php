<div class="tab-pane {{ Session::get('active_tab') == 'SEOSettingTab' ? 'active' : '' }}" id="tab-3">
    <div class="p-a-md">
        <h5>{!! __('backend.seoTabTitle') !!}</h5>
    </div>
    ...
    <div class="p-a-md col-md-12">
            ...
            <div class="radio">
                <div>
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('seo_status', '1', $WebmasterSetting->seo_status ? true : false, [
                            'id' => 'seo_status1',
                            'class' => 'has-value',
                        ]) !!}
                ...
                <div style="margin-top: 5px;">
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('seo_status', '0', $WebmasterSetting->seo_status ? false : true, [
                            'id' => 'seo_status2',
                            'class' => 'has-value',
                        ]) !!}
                        <i class="dark-white"></i>
        ...
        <div class="form-group">
            ...
            <div class="radio">
                <div>
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('links_status', '0', $WebmasterSetting->links_status ? false : true, [
                            'id' => 'links_status1',
                            'class' => 'has-value',
                        ]) !!}
                        <i class="dark-white"></i>
                ...
                <div style="margin-top: 5px;">
                    <label class="ui-check ui-check-md">
                        {!! Form::radio('links_status', '1', $WebmasterSetting->links_status ? true : false, [
                            'id' => 'links_status2',
                            'class' => 'has-value',
                        ]) !!}
                        <i class="dark-white"></i>
