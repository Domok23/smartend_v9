<div class="tab-pane {{ Session::get('active_tab') == 'textEditorTab' ? 'active' : '' }}" id="tab-12">
    <div class="p-a-md">
        <h5>{!! __('backend.textEditor') !!}</h5>
    </div>
    <div class="p-a-md col-md-12">
        ...
        <div class="m-t">
            ...
            <div class="m-x p-x {{ $WebmasterSetting->text_editor == 1 ? '' : 'displayNone' }}" id="TinyMCE">
                ...
                <input type="text" placeholder="Tiny API Key" name="tiny_key" id="tiny_key"
                    value="{{ $WebmasterSetting->tiny_key }}" class="form-control">
