                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                {!! Form::text(
                                    'seo_title_' . @$ActiveLanguage->code,
                                    $WebmasterSections->{'seo_title_' . @$ActiveLanguage->code},
                                    [
                                        'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                {!! Form::text(
                                    'seo_url_slug_' . @$ActiveLanguage->code,
                                    $WebmasterSections->{'seo_url_slug_' . @$ActiveLanguage->code},
                                    ['class' => 'form-control', 'id' => 'seo_url_slug_' . @$ActiveLanguage->code, 'dir' => @$ActiveLanguage->direction],
                                ) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                {!! Form::textarea(
                                    ...
                                    $WebmasterSections->{'seo_description_' . @$ActiveLanguage->code},
                                    [
                                        'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                {!! Form::textarea(
                                    ...
                                    $WebmasterSections->{'seo_keywords_' . @$ActiveLanguage->code},
                                    [
                                        'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div class="search-example-div">
                                ...
                                <div class="search-example" dir="{{ @$ActiveLanguage->direction }}">
                                    <a id="title_in_engines_{{ @$ActiveLanguage->code }}" href="{{ $seo_example_url }}"
                                        target="_blank">{{ $seo_example_title }}</a>
                                    <span id="url_in_engines_{{ @$ActiveLanguage->code }}">{{ $seo_example_url }}</span>
                                    <div id="desc_in_engines_{{ @$ActiveLanguage->code }}">{{ $seo_example_desc }}
                                        ...
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            @foreach (Helper::languagesList() as $ActiveLanguage)
                ...
                $("#seo_url_slug_{{ @$ActiveLanguage->code }}").on('keyup change', function() {
                    if ($(this).val() != "") {
                        $("#url_in_engines_{{ @$ActiveLanguage->code }}").text("<?php echo url(''); ?>/" + slugify($(this)
                            .val()));
                    } else {
