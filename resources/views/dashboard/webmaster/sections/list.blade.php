                        ...
                        <tbody>
                            ...
                            @foreach ($WebmasterSections as $WebSection)
                                ...
                                <tr>
                                    ...
                                    <td class="h6">
                                        {!! Form::text('row_no_' . $WebSection->id, $WebSection->row_no, [
                                            'class' => 'form-control row_no',
                                            'id' => 'row_no',
                                        ]) !!}
                                        {!! $title !!}</td>
                                    <td class="text-center">{!! $WebSection->type == 5
                                        ? "<span class='label accent'><i class='fa fa-table'></i>  " . __('backend.tableView') . '</span>'
                                        : '' !!}
                                        {!! $WebSection->type == 6
                                            ? "<span class='label accent'><i class='material-icons'>&#xe31f;</i>  " . __('backend.publicForm') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->type == 4
                                            ? "<span class='label warn'><i class='material-icons'>&#xe899;</i>  " . __('backend.private') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->type == 3
                                            ? "<span class='label blue'><i class='material-icons'>&#xe050;</i>  " . __('backend.typeSounds') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->type == 2
                                            ? "<span class='label red'><i class='material-icons'>&#xe63a;</i>  " . __('backend.typeVideos') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->type == 1
                                            ? "<span class='label green'><i class='material-icons'>&#xe251;</i>  " . __('backend.typePhotos') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->type == 0
                                            ? "<span class='label'><i class='material-icons'>&#xe165;</i>  " . __('backend.typeTextPages') . '</span>'
                                            : '' !!}
                                    </td>
                                    <td class="text-center">
                                        {!! $WebSection->sections_status == 2
                                            ? "<span class='label'><i class='material-icons'>&#xe23e;</i>  " . __('backend.mainAndSubCategories') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->sections_status == 1
                                            ? "<span class='label'><i class='material-icons'>&#xe241;</i>  " . __('backend.mainCategoriesOnly') . '</span>'
                                            : '' !!}
                                        {!! $WebSection->sections_status == 0
                                            ? "<span class='label'><i class='material-icons'>&#xe14b;</i>  " . __('backend.withoutCategories') . '</span>'
                                            : '' !!}
                                    </td>
                                    <td class="text-center">
                                        <i
                                            class="fa {{ $WebSection->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                    </td>
                                    @if (env('RSS_STATUS', 0))
                                        <td class="text-center">
