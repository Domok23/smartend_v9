            ...
            <div class="box-body">
                ...
                @foreach (Helper::languagesList() as $ActiveLanguage)
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label">{!! __('backend.sectionName') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                        </label>
                        <div class="col-sm-10">
                        ...
                        <div class="radio secs">
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '0', true, ['id' => 'site_status1', 'class' => 'has-value']) !!}
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '1', false, ['id' => 'site_status2', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '2', false, ['id' => 'site_status3', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                                    <span class="material-icons sec-icon pull-right">&#xe04b;</span>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '3', false, ['id' => 'site_status4', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                                    <span class="material-icons sec-icon pull-right">&#xe3a1;</span>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '5', false, ['id' => 'site_status6', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '4', false, ['id' => 'site_status5', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                                    <span class="material-icons sec-icon pull-right">&#xe327;</span>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    {!! Form::radio('type', '6', false, ['id' => 'site_status6', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                                    <span class="material-icons sec-icon pull-right">&#xe31f;</span>
                        ...
                        <div class="radio">
                            <div>
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('sections_status', '0', true, ['id' => 'sections_status1', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                            ...
                            <div>
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('sections_status', '1', false, ['id' => 'sections_status2', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                            ...
                            <div>
                                <label class="ui-check ui-check-md">
                                    {!! Form::radio('sections_status', '2', false, ['id' => 'sections_status3', 'class' => 'has-value']) !!}
                                    <i class="dark-white"></i>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('title_status', '1', true, ['id' => 'title_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('title_status', '0', false, ['id' => 'title_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('date_status', '1', false, ['id' => 'date_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('date_status', '0', true, ['id' => 'date_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    <label for="expire_date_status1" class="col-sm-2 form-control-label">{!! __('backend.expireDateField') !!}</label>
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('expire_date_status', '1', false, ['id' => 'expire_date_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('expire_date_status', '0', true, ['id' => 'expire_date_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('longtext_status', '1', false, ['id' => 'longtext_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('longtext_status', '0', true, ['id' => 'longtext_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('editor_status', '1', false, ['id' => 'editor_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('editor_status', '0', true, ['id' => 'editor_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('case_status', '1', false, ['id' => 'case_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('case_status', '0', true, ['id' => 'case_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('visits_status', '1', false, ['id' => 'visits_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('visits_status', '0', true, ['id' => 'visits_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('photo_status', '1', false, ['id' => 'photo_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('photo_status', '0', true, ['id' => 'photo_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('attach_file_status', '1', false, ['id' => 'attach_file_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('attach_file_status', '0', true, ['id' => 'attach_file_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('section_icon_status', '1', false, ['id' => 'section_icon_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('section_icon_status', '0', true, ['id' => 'section_icon_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('icon_status', '1', false, ['id' => 'icon_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('icon_status', '0', true, ['id' => 'icon_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('multi_images_status', '1', false, ['id' => 'multi_images_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('multi_images_status', '0', true, ['id' => 'multi_images_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('extra_attach_file_status', '1', false, [
                                    'id' => 'extra_attach_file_status1',
                                    'class' => 'has-value',
                                ]) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            ...
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('extra_attach_file_status', '0', true, [
                                    'id' => 'extra_attach_file_status2',
                                    'class' => 'has-value',
                                ]) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('maps_status', '1', false, ['id' => 'maps_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('maps_status', '0', true, ['id' => 'maps_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('order_status', '1', false, ['id' => 'order_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('order_status', '0', true, ['id' => 'order_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('comments_status', '1', false, ['id' => 'comments_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('comments_status', '0', true, ['id' => 'comments_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('related_status', '1', false, ['id' => 'related_status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.yes') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('related_status', '0', true, ['id' => 'related_status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.no') }}
                            </label>
                        </div>
