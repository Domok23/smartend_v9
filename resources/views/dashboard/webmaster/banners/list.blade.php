                                ...
                                <tr>
                                    <td class="dker"><label class="ui-check m-a-0">
                                            <input type="checkbox" name="ids[]" value="{{ $WebmasterBanner->id }}"><i
                                                class="dark-white"></i>
                                            {!! Form::hidden('row_ids[]', $WebmasterBanner->id, ['class' => 'form-control row_no']) !!}
                                        </label>
                                    </td>
                                    <td class="h6">
                                        {!! Form::text('row_no_' . $WebmasterBanner->id, $WebmasterBanner->row_no, [
                                            'class' => 'form-control row_no',
                                            'id' => 'row_no',
                                        ]) !!}
                                        {!! $title !!}</td>
                                    <td class="text-center">{!! $WebmasterBanner->type == 2
                                        ? "<span class='label red'><i class='material-icons'>&#xe63a;</i>  " . __('backend.sectionTypeVideo') . '</span>'
                                        : '' !!}
                                        {!! $WebmasterBanner->type == 1
                                            ? "<span class='label green'><i class='material-icons'>&#xe251;</i>  " . __('backend.sectionTypePhoto') . '</span>'
                                            : '' !!}
                                        {!! $WebmasterBanner->type == 0
                                            ? "<span class='label'><i class='material-icons'>&#xe86f;</i>  " . __('backend.sectionTypeCode') . '</span>'
                                            : '' !!}
                                    </td>
                                    <td class="text-center">{{ $WebmasterBanner->width }}* {{ $WebmasterBanner->height }}
                                    </td>
                                    <td class="text-center">
                                        <i
                                            class="fa {{ $WebmasterBanner->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                    </td>
                                    <td class="text-center">
