...
@section('content')
        ...
        <div class="modal-dialog" id="animate">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('calendarUpdateAll') }}" class="btn danger p-x-md">{{ __('backend.yes') }}</a>
                </div>
            </div><!-- /.modal-content -->
        </div>
    </div>
    ...
    <div class="padding">
        <div class="row m-b">
            <div class="col-sm-4 m-b-sm">
                <button type="button" class="btn btn-sm primary" id="btnNew" data-toggle="modal" data-target="#mmn-new"
                    ui-toggle-class="bounce" ui-target="#animate"><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.newEvent') }}</button>
                <button type="button" id="btnEdit" data-toggle="modal" class="displayNone" data-target="#mmn-edit"
                    ui-toggle-class="bounce" ui-target="#animate">{{ __('backend.edit') }}</button>
    ...
    eventResize: function(event, delta, revertFunc) {
        ...
        <small><a data-dismiss="modal" data-toggle="modal" data-target="#m-deleteAll" ui-toggle-class="bounce"
