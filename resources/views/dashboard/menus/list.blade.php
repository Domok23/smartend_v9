                                ...
                                <ul class="list p-b-1" style="list-style: none;">
                                    ...
                                    @foreach ($ParentMenus as $ParentMenu)
                                        ...
                                        <li style="margin-bottom: 5px"
                                            ...
                                            <div id="grpRow{{ $ParentMenu->id }}" style="display: none" class="pull-right">
                                                <a class="btn btn-sm success p-a-0 m-a-0" title="{{ __('backend.edit') }}"
                                                ...
                                                <button class="btn btn-sm warning p-a-0 m-a-0" data-toggle="modal"
                                                    data-target="#mg-{{ $ParentMenu->id }}" ui-toggle-class="bounce"
                                                    title="{{ __('backend.delete') }}" ui-target="#animate">
                                                    <small>&nbsp;<i class="material-icons">&#xe872;</i>&nbsp;
                                                    </small>
                                                </button>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($Menus as $Menu)
                                            ...
                                            <tr>
                                                ...
                                                <td class="h6">
                                                    {!! Form::text('row_no_' . $Menu->id, $Menu->row_no, ['class' => 'form-control row_no', 'id' => 'row_no']) !!}
                                                    {!! $title !!}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/dashboard/images/treepart_' . @Helper::currentLanguage()->direction . '.png') }}"
                                                            class="submenu_tree">
                                                        {!! Form::text('row_no_' . $subMenu->id, $subMenu->row_no, ['class' => 'form-control row_no', 'id' => 'row_no']) !!}
                                                        {!! $title !!}
                                                    </td>
                                                    <td class="text-center">
                                                        <i
