            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-9">
                        <select name="father_id" id="father_id" class="form-control c-select">
                            ...
                            @foreach ($FatherMenus as $FatherMenu)
                                ...
                                ?>
                                <option value="{{ $FatherMenu->id }}"
                                    {{ $FatherMenu->id == $Menus->father_id ? "selected='selected'" : '' }}>
                                    {{ $title }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                @foreach (Helper::languagesList() as $ActiveLanguage)
                    @if ($ActiveLanguage->box_status)
                        <div class="form-group row">
                            <label class="col-sm-3 form-control-label">{!! __('backend.bannerTitle') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                            </label>
                            <div class="col-sm-9">
                                {!! Form::text('title_' . @$ActiveLanguage->code, $Menus->{'title_' . @$ActiveLanguage->code}, [
                                    'placeholder' => '',
                                    'class' => 'form-control',
                                    'required' => '',
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('type', '0', $Menus->type == 0 ? true : false, [
                                    'id' => 'status1',
                                    'class' => 'has-value',
                                    'onclick' =>
                            ...
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('type', '1', $Menus->type == 1 ? true : false, [
                                    'id' => 'status2',
                                    'class' => 'has-value',
                                    'onclick' =>
                            ...
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('type', '2', $Menus->type == 2 ? true : false, [
                                    'id' => 'status2',
                                    'class' => 'has-value',
                                    'onclick' =>
                            ...
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('type', '3', $Menus->type == 3 ? true : false, [
                                    'id' => 'status2',
                                    'class' => 'has-value',
                                    'onclick' =>
                                        'document.getElementById("link_div").style.display="none";document.getElementById("cat_div").style.display="block"',
                ...
                <div id="link_div" class="form-group row" style="{{ $Menus->type == 1 ? '' : 'display: none' }}">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('link', $Menus->link, ['placeholder' => '', 'class' => 'form-control', 'dir' => 'ltr']) !!}
                    </div>
                </div>
                        ...
                        <select name="cat_id" id="cat_id" class="form-control c-select">
                            ...
                            @foreach ($GeneralWebmasterSections as $WSection)
                                @if ($WSection->type != 4)
                                    ...
                                    ?>
                                    <option value="{{ $WSection->id }}"
                                        {{ $WSection->id == $Menus->cat_id ? "selected='selected'" : '' }}>
                ...
                <div class="form-group row">
                    <label for="link_status" class="col-sm-3 form-control-label">{!! __('backend.status') !!}</label>
                    <div class="col-sm-9">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('status', '1', $Menus->status == 1 ? true : false, ['id' => 'status1', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
                                {{ __('backend.active') }}
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('status', '0', $Menus->status == 0 ? true : false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                <i class="dark-white"></i>
