                    ...
                    <div class="padding p-y-sm">
                        ...
                        <div class="row-col h-auto m-b-1">
                            <div class="col-sm-3">
                                <div class="avatar w-64 inline">
                                    ...
                                    @else
                                        <img id="photo_preview" src="{{ asset('uploads/contacts/profile.jpg') }}"
                                            style="opacity: 0.2">
                                    @endif
                                </div>
                            ...
                            <div class="col-sm-9 v-m h2 _300">
                                <div class="p-l-xs">
                                    {!! Form::text('first_name', Session::get('ContactToEdit')->first_name, [
                                        'placeholder' => __('backend.firstName'),
                                        'class' => 'form-control w-sm inline',
                                        'id' => 'first_name',
                                        'required' => '',
                                    ]) !!}
                                    {!! Form::text('last_name', Session::get('ContactToEdit')->last_name, [
                                        'placeholder' => __('backend.lastName'),
                                        'class' => 'form-control w-sm inline',
                                        'id' => 'last_name',
                                        'required' => '',
                                    ]) !!}
                                    @if (count($ContactsGroups) > 0)
                                        <select name="group_id" class="form-control c-select w-sm inline"
                                            ...
                                            @foreach ($ContactsGroups as $Group)
                                                <option value="{{ $Group->id }}"
                                                    {{ $Group->id == Session::get('ContactToEdit')->group_id ? "selected='selected'" : '' }}>
                                                    {{ $Group->name }}</option>
                                            @endforeach
                        ...
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    {!! Form::text('phone', Session::get('ContactToEdit')->phone, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'phone',
                                    ]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    {!! Form::email('email', Session::get('ContactToEdit')->email, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'email',
                                        'required' => '',
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('company', Session::get('ContactToEdit')->company, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'company',
                                    ]) !!}
                                    ...
                                    <select name="country_id" id="country_id"
                                        ...
                                        @foreach ($Countries as $country)
                                            ...
                                            <option value="{{ $country->id }}"
                                                {{ $country->id == Session::get('ContactToEdit')->country_id ? "selected='selected'" : '' }}>
                                                {{ $title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-3">
                                    {!! Form::text('city', Session::get('ContactToEdit')->city, [
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::textarea('notes', Session::get('ContactToEdit')->notes, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'rows' => '2',
                                    ]) !!}
                                ...
                                <div class="col-sm-9">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('status', '1', Session::get('ContactToEdit')->status == 1 ? true : false, [
                                                'id' => 'status1',
                                                'class' => 'has-value',
                                            ]) !!}
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('status', '0', Session::get('ContactToEdit')->status == 0 ? true : false, [
                                                'id' => 'status3',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('status', '2', Session::get('ContactToEdit')->status == 2 ? true : false, [
                                                'id' => 'status2',
                                                'class' => 'has-value',
                                            ]) !!}
                                            <i class="dark-white"></i>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    @endif
                                    <!-- .modal -->
                                    <div id="mc-{{ Session::get('ContactToEdit')->id }}" class="modal fade"
                                        data-backdrop="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center p-lg">
                                                    <p>
                                                        ...
                                                        <br>
                                                        <strong>[ {{ Session::get('ContactToEdit')->first_name }}
                                                            {{ Session::get('ContactToEdit')->last_name }}
                                                            ]</strong>
                                                    </p>
                                                </div>
