                    ...
                    <div class="padding p-y-sm ">
                                        ...
                                        <select name="group_id" class="form-control c-select w-sm inline"
                                            ...
                                            @foreach ($ContactsGroups as $Group)
                                                <option value="{{ $Group->id }}"
                                                    {{ $Group->id == $group_id ? "selected='selected'" : '' }}>
                                                    {{ $Group->name }}</option>
                                            @endforeach
                                        </select>
                                    @endif
                        ...
                        <div class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('phone', '', ['placeholder' => '', 'class' => 'form-control', 'id' => 'phone']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('company', '', ['placeholder' => '', 'class' => 'form-control', 'id' => 'company']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::text('city', '', ['placeholder' => '', 'class' => 'form-control', 'id' => 'city']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::textarea('notes', '', ['placeholder' => '', 'class' => 'form-control', 'rows' => '2']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
